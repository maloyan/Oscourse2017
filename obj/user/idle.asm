...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044b:	ba b8 1e 80 00       	mov    $0x801eb8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800476:	51                   	push   %ecx
  800477:	50                   	push   %eax
  800478:	68 3c 1e 80 00       	push   $0x801e3c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006a3:	53                   	push   %ebx
  8006a4:	50                   	push   %eax
  8006a5:	68 7d 1e 80 00       	push   $0x801e7d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800774:	53                   	push   %ebx
  800775:	50                   	push   %eax
  800776:	68 99 1e 80 00       	push   $0x801e99
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800829:	53                   	push   %ebx
  80082a:	50                   	push   %eax
  80082b:	68 5c 1e 80 00       	push   $0x801e5c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a90:	68 c8 1e 80 00       	push   $0x801ec8
  800a95:	68 cf 1e 80 00       	push   $0x801ecf
  800a9a:	6a 7c                	push   $0x7c
  800a9c:	68 e4 1e 80 00       	push   $0x801ee4
  800aa1:	e8 b5 05 00 00       	call   80105b <_panic>
	assert(r <= PGSIZE);
  800aa6:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800aab:	7e 16                	jle    800ac3 <devfile_read+0x65>
  800aad:	68 ef 1e 80 00       	push   $0x801eef
  800ab2:	68 cf 1e 80 00       	push   $0x801ecf
  800ab7:	6a 7d                	push   $0x7d
  800ab9:	68 e4 1e 80 00       	push   $0x801ee4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b9c:	68 fb 1e 80 00       	push   $0x801efb
  800ba1:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c44:	52                   	push   %edx
  800c45:	53                   	push   %ebx
  800c46:	68 08 1f 80 00       	push   $0x801f08
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ee7:	68 39 1f 80 00       	push   $0x801f39
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801077:	56                   	push   %esi
  801078:	50                   	push   %eax
  801079:	68 48 1f 80 00       	push   $0x801f48
  ...
  80108a:	e8 54 00 00 00       	call   8010e3 <vcprintf>
	cprintf("\n");
  80108f:	c7 04 24 97 1e 80 00 	movl   $0x801e97,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011dd:	0f be 80 6b 1f 80 00 	movsbl 0x801f6b(%eax),%eax
  8011e4:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013a7:	50                   	push   %eax
  8013a8:	68 83 1f 80 00       	push   $0x801f83
  8013ad:	53                   	push   %ebx
  8013ae:	56                   	push   %esi
  ...
  8013bf:	52                   	push   %edx
  8013c0:	68 e1 1e 80 00       	push   $0x801ee1
  8013c5:	53                   	push   %ebx
  8013c6:	56                   	push   %esi
  ...
  8013ed:	75 05                	jne    8013f4 <vprintfmt+0x18e>
				p = "(null)";
  8013ef:	bf 7c 1f 80 00       	mov    $0x801f7c,%edi
			if (width > 0 && padc != '-')
