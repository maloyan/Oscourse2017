...
obj/user/vdate:     file format elf32-i386
...
void umain (int argc, char **argv) {
  ...
  800312:	e8 6a 18 00 00       	call   801b81 <vsys_gettime>
    struct tm tnow;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004e5:	e8 56 19 00 00       	call   801e40 <__udivdi3>
  ...
  800523:	e8 48 1a 00 00       	call   801f70 <__umoddi3>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015e5:	e8 dc 07 00 00       	call   801dc6 <ipc_find_env>
  ...
  801600:	e8 70 07 00 00       	call   801d75 <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  801605:	83 c4 0c             	add    $0xc,%esp
  801608:	6a 00                	push   $0x0
  80160a:	53                   	push   %ebx
  80160b:	6a 00                	push   $0x0
  80160d:	e8 fd 06 00 00       	call   801d0f <ipc_recv>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8018c0:	57                   	push   %edi
  8018c1:	e8 38 05 00 00       	call   801dfe <pageref>
  8018c6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8018c9:	89 34 24             	mov    %esi,(%esp)
  8018cc:	e8 2d 05 00 00       	call   801dfe <pageref>
...
int vsys_gettime(void)
{
  ...
  801b82:	89 e5                	mov    %esp,%ebp
	...
	//while(i-- );
	return vsys[num];
  801b84:	a1 00 00 80 ee       	mov    0xee800000,%eax
}
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b9b:	68 f8 25 80 00       	push   $0x8025f8
  801ba0:	ff 75 0c             	pushl  0xc(%ebp)
  801ba3:	e8 5e ee ff ff       	call   800a06 <strcpy>
	return 0;
}
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  801bb3:	56                   	push   %esi
  801bb4:	53                   	push   %ebx
  801bb5:	81 ec 8c 00 00 00    	sub    $0x8c,%esp
	int tot, m;
	char buf[128];
  ...
  801bc0:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
	int tot, m;
	char buf[128];
	...
	// so we have to copy vbuf into buf in chunks and nul-terminate.
	for (tot = 0; tot < n; tot += m) {
  801bc6:	eb 2e                	jmp    801bf6 <devcons_write+0x47>
		m = n - tot;
  801bc8:	8b 55 10             	mov    0x10(%ebp),%edx
  801bcb:	29 da                	sub    %ebx,%edx
		if (m > sizeof(buf) - 1)
			m = sizeof(buf) - 1;
  801bcd:	be 7f 00 00 00       	mov    $0x7f,%esi
	...
	for (tot = 0; tot < n; tot += m) {
		m = n - tot;
		if (m > sizeof(buf) - 1)
  801bd2:	83 fa 7f             	cmp    $0x7f,%edx
  801bd5:	77 02                	ja     801bd9 <devcons_write+0x2a>
	char buf[128];
  ...
  801be0:	50                   	push   %eax
  801be1:	57                   	push   %edi
  801be2:	e8 b1 ef ff ff       	call   800b98 <memmove>
		sys_cputs(buf, m);
  801be7:	83 c4 08             	add    $0x8,%esp
  801bea:	56                   	push   %esi
  801beb:	57                   	push   %edi
  801bec:	e8 63 f1 ff ff       	call   800d54 <sys_cputs>
	int tot, m;
	char buf[128];
  ...
  801bf8:	3b 5d 10             	cmp    0x10(%ebp),%ebx
  801bfb:	72 cb                	jb     801bc8 <devcons_write+0x19>
			m = sizeof(buf) - 1;
		memmove(buf, (char*)vbuf + tot, m);
		sys_cputs(buf, m);
	}
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801c14:	75 07                	jne    801c1d <devcons_read+0x18>
  801c16:	eb 28                	jmp    801c40 <devcons_read+0x3b>
		return 0;

	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801c18:	e8 d4 f1 ff ff       	call   800df1 <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  801c1d:	e8 50 f1 ff ff       	call   800d72 <sys_cgetc>
...
cputchar(int ch)
{
  ...
  801c53:	50                   	push   %eax
  801c54:	e8 fb f0 ff ff       	call   800d54 <sys_cputs>
...
getchar(void)
{
  ...
  801c6c:	e8 8e f6 ff ff       	call   8012ff <read>
	if (r < 0)
...
iscons(int fdnum)
{
  ...
  801c96:	e8 fb f3 ff ff       	call   801096 <fd_lookup>
...
opencons(void)
{
  ...
  801cbe:	50                   	push   %eax
  801cbf:	e8 83 f3 ff ff       	call   801047 <fd_alloc>
...
opencons(void)
{
  ...
  801cda:	e8 31 f1 ff ff       	call   800e10 <sys_page_alloc>
  ...
  801d00:	50                   	push   %eax
  801d01:	e8 1a f3 ff ff       	call   801020 <fd2num>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d1f:	74 06                	je     801d27 <ipc_recv+0x18>
  801d21:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if (perm_store) *perm_store = 0;
  801d27:	85 db                	test   %ebx,%ebx
  801d29:	74 06                	je     801d31 <ipc_recv+0x22>
  801d2b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	if (!pg) pg = (void*) -1;
  801d31:	83 f8 01             	cmp    $0x1,%eax
  801d34:	19 d2                	sbb    %edx,%edx
  801d36:	09 d0                	or     %edx,%eax
	int ret = sys_ipc_recv(pg);
  801d38:	83 ec 0c             	sub    $0xc,%esp
  801d3b:	50                   	push   %eax
  801d3c:	e8 7f f2 ff ff       	call   800fc0 <sys_ipc_recv>
  801d41:	89 c2                	mov    %eax,%edx
	if (ret) return ret;
  801d43:	83 c4 10             	add    $0x10,%esp
  801d46:	85 d2                	test   %edx,%edx
  801d48:	75 24                	jne    801d6e <ipc_recv+0x5f>
	if (from_env_store)
  801d4a:	85 f6                	test   %esi,%esi
  801d4c:	74 0a                	je     801d58 <ipc_recv+0x49>
		*from_env_store = thisenv->env_ipc_from;
  801d4e:	a1 04 40 80 00       	mov    0x804004,%eax
  801d53:	8b 40 70             	mov    0x70(%eax),%eax
  801d56:	89 06                	mov    %eax,(%esi)
	if (perm_store)
  801d58:	85 db                	test   %ebx,%ebx
  801d5a:	74 0a                	je     801d66 <ipc_recv+0x57>
		*perm_store = thisenv->env_ipc_perm;
  801d5c:	a1 04 40 80 00       	mov    0x804004,%eax
  801d61:	8b 40 74             	mov    0x74(%eax),%eax
  801d64:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  801d66:	a1 04 40 80 00       	mov    0x804004,%eax
  801d6b:	8b 40 6c             	mov    0x6c(%eax),%eax
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d84:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 9: Your code here.
	if (!pg) pg = (void*)-1;
  801d87:	83 fb 01             	cmp    $0x1,%ebx
  801d8a:	19 c0                	sbb    %eax,%eax
  801d8c:	09 c3                	or     %eax,%ebx
  801d8e:	eb 1c                	jmp    801dac <ipc_send+0x37>
	int ret;
	while ((ret = sys_ipc_try_send(to_env, val, pg, perm))) {
		if (ret == 0) break;
		if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %i", ret);
  801d90:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d93:	74 12                	je     801da7 <ipc_send+0x32>
  801d95:	50                   	push   %eax
  801d96:	68 04 26 80 00       	push   $0x802604
  801d9b:	6a 36                	push   $0x36
  801d9d:	68 1b 26 80 00       	push   $0x80261b
  801da2:	e8 02 e6 ff ff       	call   8003a9 <_panic>
		sys_yield();
  801da7:	e8 45 f0 ff ff       	call   800df1 <sys_yield>
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
	// LAB 9: Your code here.
	if (!pg) pg = (void*)-1;
  ...
  801db0:	56                   	push   %esi
  801db1:	57                   	push   %edi
  801db2:	e8 e6 f1 ff ff       	call   800f9d <sys_ipc_try_send>
		if (ret == 0) break;
  801db7:	83 c4 10             	add    $0x10,%esp
  801dba:	85 c0                	test   %eax,%eax
  801dbc:	75 d2                	jne    801d90 <ipc_send+0x1b>
		if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %i", ret);
		sys_yield();
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801dd1:	6b d0 78             	imul   $0x78,%eax,%edx
  801dd4:	83 c2 50             	add    $0x50,%edx
  801dd7:	8b 92 00 00 c0 ee    	mov    -0x11400000(%edx),%edx
  801ddd:	39 ca                	cmp    %ecx,%edx
  801ddf:	75 0d                	jne    801dee <ipc_find_env+0x28>
			return envs[i].env_id;
  801de1:	6b c0 78             	imul   $0x78,%eax,%eax
  801de4:	05 40 00 c0 ee       	add    $0xeec00040,%eax
  801de9:	8b 40 08             	mov    0x8(%eax),%eax
  801dec:	eb 0e                	jmp    801dfc <ipc_find_env+0x36>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801df1:	3d 00 04 00 00       	cmp    $0x400,%eax
  801df6:	75 d9                	jne    801dd1 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
  801df8:	66 b8 00 00          	mov    $0x0,%ax
}
  801dfc:	5d                   	pop    %ebp
  801dfd:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e09:	8b 0c 85 00 d0 7b ef 	mov    -0x10843000(,%eax,4),%ecx
		return 0;
...
pageref(void *v)
{
	...
	if (!(uvpd[PDX(v)] & PTE_P))
  801e15:	f6 c1 01             	test   $0x1,%cl
  801e18:	74 1d                	je     801e37 <pageref+0x39>
		return 0;
	pte = uvpt[PGNUM(v)];
  801e1a:	c1 ea 0c             	shr    $0xc,%edx
  801e1d:	8b 14 95 00 00 40 ef 	mov    -0x10c00000(,%edx,4),%edx
	if (!(pte & PTE_P))
  801e24:	f6 c2 01             	test   $0x1,%dl
  801e27:	74 0e                	je     801e37 <pageref+0x39>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e29:	c1 ea 0c             	shr    $0xc,%edx
  801e2c:	0f b7 04 d5 04 00 00 	movzwl -0x10fffffc(,%edx,8),%eax
  801e33:	ef 
  801e34:	0f b7 c0             	movzwl %ax,%eax
}
  801e37:	5d                   	pop    %ebp
  801e38:	c3                   	ret    
...
00801e40 <__udivdi3>:
  ...
  801e46:	8b 54 24 2c          	mov    0x2c(%esp),%edx
  801e4a:	8b 7c 24 20          	mov    0x20(%esp),%edi
  801e4e:	8b 74 24 24          	mov    0x24(%esp),%esi
  801e52:	8b 4c 24 28          	mov    0x28(%esp),%ecx
  801e56:	85 d2                	test   %edx,%edx
  801e58:	89 7c 24 04          	mov    %edi,0x4(%esp)
  801e5c:	89 34 24             	mov    %esi,(%esp)
  801e5f:	89 c8                	mov    %ecx,%eax
  801e61:	75 35                	jne    801e98 <__udivdi3+0x58>
  801e63:	39 f1                	cmp    %esi,%ecx
  801e65:	0f 87 bd 00 00 00    	ja     801f28 <__udivdi3+0xe8>
  801e6b:	85 c9                	test   %ecx,%ecx
  801e6d:	89 cd                	mov    %ecx,%ebp
  ...
  801e9b:	77 7b                	ja     801f18 <__udivdi3+0xd8>
  801e9d:	0f bd f2             	bsr    %edx,%esi
  801ea0:	83 f6 1f             	xor    $0x1f,%esi
  801ea3:	0f 84 97 00 00 00    	je     801f40 <__udivdi3+0x100>
  801ea9:	bd 20 00 00 00       	mov    $0x20,%ebp
  801eae:	89 d7                	mov    %edx,%edi
  801eb0:	89 f1                	mov    %esi,%ecx
  801eb2:	29 f5                	sub    %esi,%ebp
  801eb4:	d3 e7                	shl    %cl,%edi
  801eb6:	89 c2                	mov    %eax,%edx
  801eb8:	89 e9                	mov    %ebp,%ecx
  801eba:	d3 ea                	shr    %cl,%edx
  801ebc:	89 f1                	mov    %esi,%ecx
  801ebe:	09 fa                	or     %edi,%edx
  801ec0:	8b 3c 24             	mov    (%esp),%edi
  801ec3:	d3 e0                	shl    %cl,%eax
  801ec5:	89 54 24 08          	mov    %edx,0x8(%esp)
  801ec9:	89 e9                	mov    %ebp,%ecx
  801ecb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801ecf:	8b 44 24 04          	mov    0x4(%esp),%eax
  801ed3:	89 fa                	mov    %edi,%edx
  801ed5:	d3 ea                	shr    %cl,%edx
  801ed7:	89 f1                	mov    %esi,%ecx
  801ed9:	d3 e7                	shl    %cl,%edi
  801edb:	89 e9                	mov    %ebp,%ecx
  801edd:	d3 e8                	shr    %cl,%eax
  801edf:	09 c7                	or     %eax,%edi
  801ee1:	89 f8                	mov    %edi,%eax
  801ee3:	f7 74 24 08          	divl   0x8(%esp)
  801ee7:	89 d5                	mov    %edx,%ebp
  801ee9:	89 c7                	mov    %eax,%edi
  801eeb:	f7 64 24 0c          	mull   0xc(%esp)
  801eef:	39 d5                	cmp    %edx,%ebp
  801ef1:	89 14 24             	mov    %edx,(%esp)
  801ef4:	72 11                	jb     801f07 <__udivdi3+0xc7>
  801ef6:	8b 54 24 04          	mov    0x4(%esp),%edx
  801efa:	89 f1                	mov    %esi,%ecx
  801efc:	d3 e2                	shl    %cl,%edx
  801efe:	39 c2                	cmp    %eax,%edx
  801f00:	73 5e                	jae    801f60 <__udivdi3+0x120>
  801f02:	3b 2c 24             	cmp    (%esp),%ebp
  801f05:	75 59                	jne    801f60 <__udivdi3+0x120>
  801f07:	8d 47 ff             	lea    -0x1(%edi),%eax
  ...
  801f40:	3b 4c 24 04          	cmp    0x4(%esp),%ecx
  801f44:	76 0b                	jbe    801f51 <__udivdi3+0x111>
  801f46:	31 c0                	xor    %eax,%eax
  801f48:	3b 14 24             	cmp    (%esp),%edx
  801f4b:	0f 83 37 ff ff ff    	jae    801e88 <__udivdi3+0x48>
  801f51:	b8 01 00 00 00       	mov    $0x1,%eax
  801f56:	e9 2d ff ff ff       	jmp    801e88 <__udivdi3+0x48>
  801f5b:	90                   	nop
  801f5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801f60:	89 f8                	mov    %edi,%eax
  801f62:	31 f6                	xor    %esi,%esi
  801f64:	e9 1f ff ff ff       	jmp    801e88 <__udivdi3+0x48>
...
00801f70 <__umoddi3>:
  ...
  801f76:	8b 44 24 34          	mov    0x34(%esp),%eax
  801f7a:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  801f7e:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801f82:	89 c6                	mov    %eax,%esi
  801f84:	89 44 24 10          	mov    %eax,0x10(%esp)
  801f88:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  801f8c:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
  801f90:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801f94:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  801f98:	89 74 24 18          	mov    %esi,0x18(%esp)
  801f9c:	85 c0                	test   %eax,%eax
  801f9e:	89 c2                	mov    %eax,%edx
  801fa0:	75 1e                	jne    801fc0 <__umoddi3+0x50>
  801fa2:	39 f7                	cmp    %esi,%edi
  801fa4:	76 52                	jbe    801ff8 <__umoddi3+0x88>
  ...
  801fc2:	77 5c                	ja     802020 <__umoddi3+0xb0>
  801fc4:	0f bd e8             	bsr    %eax,%ebp
  801fc7:	83 f5 1f             	xor    $0x1f,%ebp
  801fca:	75 64                	jne    802030 <__umoddi3+0xc0>
  801fcc:	8b 6c 24 14          	mov    0x14(%esp),%ebp
  801fd0:	39 6c 24 0c          	cmp    %ebp,0xc(%esp)
  801fd4:	0f 86 f6 00 00 00    	jbe    8020d0 <__umoddi3+0x160>
  801fda:	3b 44 24 18          	cmp    0x18(%esp),%eax
  801fde:	0f 82 ec 00 00 00    	jb     8020d0 <__umoddi3+0x160>
  801fe4:	8b 44 24 14          	mov    0x14(%esp),%eax
  801fe8:	8b 54 24 18          	mov    0x18(%esp),%edx
  ...
  801ffa:	89 fd                	mov    %edi,%ebp
  801ffc:	75 0b                	jne    802009 <__umoddi3+0x99>
  ...
  80200f:	f7 f5                	div    %ebp
  802011:	89 c8                	mov    %ecx,%eax
  802013:	f7 f5                	div    %ebp
  802015:	eb 95                	jmp    801fac <__umoddi3+0x3c>
  802017:	89 f6                	mov    %esi,%esi
  ...
  802030:	b8 20 00 00 00       	mov    $0x20,%eax
  802035:	89 e9                	mov    %ebp,%ecx
  802037:	29 e8                	sub    %ebp,%eax
  802039:	d3 e2                	shl    %cl,%edx
  80203b:	89 c7                	mov    %eax,%edi
  80203d:	89 44 24 18          	mov    %eax,0x18(%esp)
  802041:	8b 44 24 0c          	mov    0xc(%esp),%eax
  802045:	89 f9                	mov    %edi,%ecx
  802047:	d3 e8                	shr    %cl,%eax
  802049:	89 c1                	mov    %eax,%ecx
  80204b:	8b 44 24 0c          	mov    0xc(%esp),%eax
  80204f:	09 d1                	or     %edx,%ecx
  802051:	89 fa                	mov    %edi,%edx
  802053:	89 4c 24 10          	mov    %ecx,0x10(%esp)
  ...
  802069:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  ...
  802079:	8b 74 24 1c          	mov    0x1c(%esp),%esi
  80207d:	f7 74 24 10          	divl   0x10(%esp)
  802081:	d3 e6                	shl    %cl,%esi
  802083:	89 d1                	mov    %edx,%ecx
  802085:	f7 64 24 0c          	mull   0xc(%esp)
  802089:	39 d1                	cmp    %edx,%ecx
  80208b:	89 74 24 14          	mov    %esi,0x14(%esp)
  80208f:	89 d7                	mov    %edx,%edi
  802091:	89 c6                	mov    %eax,%esi
  802093:	72 0a                	jb     80209f <__umoddi3+0x12f>
  802095:	39 44 24 14          	cmp    %eax,0x14(%esp)
  802099:	73 10                	jae    8020ab <__umoddi3+0x13b>
  80209b:	39 d1                	cmp    %edx,%ecx
  80209d:	75 0c                	jne    8020ab <__umoddi3+0x13b>
  80209f:	89 d7                	mov    %edx,%edi
  8020a1:	89 c6                	mov    %eax,%esi
  8020a3:	2b 74 24 0c          	sub    0xc(%esp),%esi
  8020a7:	1b 7c 24 10          	sbb    0x10(%esp),%edi
  8020ab:	89 ca                	mov    %ecx,%edx
  8020ad:	89 e9                	mov    %ebp,%ecx
  8020af:	8b 44 24 14          	mov    0x14(%esp),%eax
  8020b3:	29 f0                	sub    %esi,%eax
  8020b5:	19 fa                	sbb    %edi,%edx
  8020b7:	d3 e8                	shr    %cl,%eax
  8020b9:	0f b6 4c 24 18       	movzbl 0x18(%esp),%ecx
  8020be:	89 d7                	mov    %edx,%edi
  8020c0:	d3 e7                	shl    %cl,%edi
  8020c2:	89 e9                	mov    %ebp,%ecx
  8020c4:	09 f8                	or     %edi,%eax
  8020c6:	d3 ea                	shr    %cl,%edx
  8020c8:	83 c4 20             	add    $0x20,%esp
  8020cb:	5e                   	pop    %esi
  8020cc:	5f                   	pop    %edi
  8020cd:	5d                   	pop    %ebp
  8020ce:	c3                   	ret    
  ...
  8020d4:	29 f9                	sub    %edi,%ecx
  8020d6:	19 c6                	sbb    %eax,%esi
  8020d8:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  8020dc:	89 74 24 18          	mov    %esi,0x18(%esp)
  8020e0:	e9 ff fe ff ff       	jmp    801fe4 <__umoddi3+0x74>
